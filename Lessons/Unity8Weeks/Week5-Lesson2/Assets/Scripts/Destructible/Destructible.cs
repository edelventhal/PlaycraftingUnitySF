...
public class Destructible : MonoBehaviour
{
    ...
    public virtual void TakeDamage( float amount, Destructor damager = null )
    {
        ModifyHitPoints( -amount, damager );
    }
    ...
    public virtual void ModifyHitPoints( float amount, Destructor damager = null )
    {
