...
public class Game : MonoBehaviour
{
    ...
    public int HighScore
    {
        get 
        {
            //gives us the stored on disk "HighScore", and defaults to 0 if we don't have one.
    ...
    protected void DoPlayerLost()
    {
        ...
        //every time we die, store the current score in PlayerPrefs if it's greater than our HighScore
        if ( Score > HighScore )
        {
